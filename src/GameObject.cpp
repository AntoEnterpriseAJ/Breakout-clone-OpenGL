...
GameObject::GameObject()
    : m_sprite{}, m_position{0.0f}, m_size{0.0f},
      m_color{1.0f}, m_rotationAngle{0.0f}, m_isBreakable{false}, m_isDestroyed{true} 
{}
...
GameObject::GameObject(const Texture2D& sprite, glm::vec2 pos, glm::vec2 size, glm::vec3 color, bool isBreakable)
    : m_sprite{sprite}, m_position{pos}, m_size{size},
      m_color{color}, m_rotationAngle{0.0f}, m_isBreakable{isBreakable}, m_isDestroyed{false} 
{}
